 ...
 */}
          ...
          <div className="border-r-2 border-purple-200 max-w-3xl"><Image src={profilePic} alt="Picture of the user" className="border-6 rounded-full hover:opacity-90" width={550} height={550} 
          quality="80" /></div>

          <div> 
          <ul className="ist-none md:list-disc text-2xl">
