            ...
            <div>
              <div className="p-4 md:p-12 text-center lg:text-left">
                ...
                <div className="flex lg:float-right justify-center m-3">
                  <Link href="/settings/profileSetting">
                ...
                <div class="mx-auto lg:mx-0 w-4/5 lg:w-full mt-2 pt-3 border-b-2 border-purple-500 opacity-25"></div>
                ...
                <div className="flex flex-col mx-9 mt-10">
                  ...
                  <div className=" grid grid-cols-3 gap-4 justify-items-stretch text-center border-2 border-gray-300 rounded-lg w-full mt-2 p-3 mb-2">
